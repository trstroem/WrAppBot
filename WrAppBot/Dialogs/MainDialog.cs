...
namespace WrAppBot.Dialogs
{
    public class MainDialog : ComponentDialog
    {
        ...
        private async Task<DialogTurnResult> ActStepAsync(WaterfallStepContext stepContext, CancellationToken cancellationToken)
        {
            ...
            // Run the StoryDialog giving it whatever details we have from the LUIS call, it will fill out the remainder.
            return await stepContext.BeginDialogAsync(nameof(StoryDialog), storyDetails, cancellationToken);
        }
